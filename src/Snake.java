...
public class Snake {
    ...
    public void setJMenueBar(JFrame frame) {
        ...
        JMenu JavaProject = new JMenu("Java Project");
        JMenuItem creator = new JMenuItem("Project Details");
        JMenuItem instruction = new JMenuItem("Buid Version 1.0.0");
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {                
                JOptionPane.showMessageDialog(null, "Author: Manoranjan Padhy\nE_No:135250686006\nProject_Name:Snake Game");
            }
        });

        JavaProject.add(creator);
        JavaProject.add(instruction);
        mymbar.add(JavaProject);
    ...
    public void createInitSnake() {
        ...
        for (int i = 0; i < totalBodyPart; i++) {
            ...
            snakeBodyPart[i].setBackground(Color.CYAN);
